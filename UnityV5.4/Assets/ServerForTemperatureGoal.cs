...
public class ServerForTemperatureGoal : MonoBehaviour
{
    [SerializeField]
    ...
    int portTemperaturegoal = 10010;
    private string displaymessage = "";
    public Text temperaturegoalText;
    //public Text connectionStatus;
    //public Text variable;
    float temperaturegoalfromServer;
    ...
    public void Update()
    {
        temperaturegoalText.text="target temperature: "+temperaturegoalfromServer.ToString();
    ...
    public void ListenForMessages()
    {
        ...
        try
        {
            ...
            server = new TcpListener(localAddr, portTemperaturegoal);
            ...
            while (true)
            {
                ...
                using (TcpClient client = server.AcceptTcpClient())
                {
                    ...
                    while ((i = stream.Read(bytes, 0, bytes.Length)) != 0)
                    {
                        ...
                        float temperaturegoalfromRhapsody = (float)Convert.ToDouble(data);
                        //Debug.Log(data);
                        temperaturegoalfromServer = temperaturegoalfromRhapsody;
                        ...
                        //Debug.Log("temperaturegoal: " + temperaturegoalfromServer.ToString());
                    }
