...
//#[ ignore
#define OMAnim_Default_TemperatureSensor_callMain_ARGS_DECLARATION

#define OMAnim_Default_TemperatureSensor_changeFromAirConditioner_ARGS_DECLARATION

#define OMAnim_Default_TemperatureSensor_getTemperatureroom_ARGS_DECLARATION

#define OMAnim_Default_TemperatureSensor_setModifying_bool_bool_ARGS_DECLARATION bool newValue;
...
#ifdef _OMINSTRUMENT
DECLARE_OPERATION_CLASS(Default_TemperatureSensor_callMain)

DECLARE_OPERATION_CLASS(Default_TemperatureSensor_changeFromAirConditioner)

DECLARE_OPERATION_CLASS(Default_TemperatureSensor_getTemperatureroom)

DECLARE_OPERATION_CLASS(Default_TemperatureSensor_setModifying_bool_bool)
...
class OMAnimatedTemperatureSensor : virtual public AOMInstance {
    ...
    DECLARE_META_OP(Default_TemperatureSensor_callMain)
    
    DECLARE_META_OP(Default_TemperatureSensor_changeFromAirConditioner)
    
    DECLARE_META_OP(Default_TemperatureSensor_getTemperatureroom)
    
    DECLARE_META_OP(Default_TemperatureSensor_setModifying_bool_bool)
