...
#define OMAnim_Default_FireSensor_getFire_bool_UNSERIALIZE_ARGS

#define OMAnim_Default_FireSensor_getFire_bool_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)
...
IMPLEMENT_META_OP(OMAnimatedFireSensor, Default_FireSensor_getFire_bool, "getFire_bool", FALSE, "getFire_bool()", 0)

IMPLEMENT_OP_CALL(Default_FireSensor_getFire_bool, FireSensor, getFire_bool(), bool animRetVal = )
