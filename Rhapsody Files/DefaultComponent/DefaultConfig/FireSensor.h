...
//!	Generated Date	: Sat, 10, Jul 2021  
	File Path	: DefaultComponent\DefaultConfig\FireSensor.h
*********************************************************************/
...
//#[ ignore
#define OMAnim_Default_FireSensor_getFire_bool_ARGS_DECLARATION
...
#ifdef _OMINSTRUMENT
DECLARE_OPERATION_CLASS(Default_FireSensor_getFire_bool)
...
class OMAnimatedFireSensor : virtual public AOMInstance {
    ...
    DECLARE_META_OP(Default_FireSensor_getFire_bool)
