...
//!	Generated Date	: Sat, 10, Jul 2021  
	File Path	: DefaultComponent\DefaultConfig\IntelligentLamp.h
*********************************************************************/
...
//#[ ignore
#define OMAnim_Default_IntelligentLamp_callMain_ARGS_DECLARATION
...
#ifdef _OMINSTRUMENT
DECLARE_OPERATION_CLASS(Default_IntelligentLamp_callMain)
...
class OMAnimatedIntelligentLamp : virtual public AOMInstance {
    ...
    DECLARE_META_OP(Default_IntelligentLamp_callMain)
