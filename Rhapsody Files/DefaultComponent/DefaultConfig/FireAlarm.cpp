...
//!	Generated Date	: Sat, 10, Jul 2021  
	File Path	: DefaultComponent\DefaultConfig\FireAlarm.cpp
*********************************************************************/
...
#define OMAnim_Default_FireAlarm_FireNow_UNSERIALIZE_ARGS

#define OMAnim_Default_FireAlarm_FireNow_SERIALIZE_RET_VAL

#define Default_FireAlarm_FireStop_SERIALIZE OM_NO_OP

#define OMAnim_Default_FireAlarm_FireStop_UNSERIALIZE_ARGS

#define OMAnim_Default_FireAlarm_FireStop_SERIALIZE_RET_VAL

#define Default_FireAlarm_callMain_SERIALIZE OM_NO_OP

#define OMAnim_Default_FireAlarm_callMain_UNSERIALIZE_ARGS

#define OMAnim_Default_FireAlarm_callMain_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define Default_FireAlarm_getFirealarm_bool_SERIALIZE OM_NO_OP

#define OMAnim_Default_FireAlarm_getFirealarm_bool_UNSERIALIZE_ARGS

#define OMAnim_Default_FireAlarm_getFirealarm_bool_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define OMAnim_Default_FireAlarm_setFire_bool_bool_UNSERIALIZE_ARGS OP_UNSER(OMDestructiveString2X,p_fire_bool)

#define OMAnim_Default_FireAlarm_setFire_bool_bool_SERIALIZE_RET_VAL
...
IMPLEMENT_META_OP(OMAnimatedFireAlarm, Default_FireAlarm_FireNow, "FireNow", FALSE, "FireNow()", 0)

IMPLEMENT_OP_CALL(Default_FireAlarm_FireNow, FireAlarm, FireNow(), NO_OP())

IMPLEMENT_META_OP(OMAnimatedFireAlarm, Default_FireAlarm_FireStop, "FireStop", FALSE, "FireStop()", 0)

IMPLEMENT_OP_CALL(Default_FireAlarm_FireStop, FireAlarm, FireStop(), NO_OP())

IMPLEMENT_META_OP(OMAnimatedFireAlarm, Default_FireAlarm_callMain, "callMain", FALSE, "callMain()", 0)

IMPLEMENT_OP_CALL(Default_FireAlarm_callMain, FireAlarm, callMain(), int animRetVal = )

IMPLEMENT_META_OP(OMAnimatedFireAlarm, Default_FireAlarm_getFirealarm_bool, "getFirealarm_bool", FALSE, "getFirealarm_bool()", 0)

IMPLEMENT_OP_CALL(Default_FireAlarm_getFirealarm_bool, FireAlarm, getFirealarm_bool(), bool animRetVal = )

IMPLEMENT_META_OP(OMAnimatedFireAlarm, Default_FireAlarm_setFire_bool_bool, "setFire_bool", FALSE, "setFire_bool(bool)", 1)

IMPLEMENT_OP_CALL(Default_FireAlarm_setFire_bool_bool, FireAlarm, setFire_bool(p_fire_bool), NO_OP())
