...
#define OMAnim_Default_a_callMain_UNSERIALIZE_ARGS

#define OMAnim_Default_a_callMain_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)
//#]
...
IMPLEMENT_META_OP(OMAnimateda, Default_a_callMain, "callMain", FALSE, "callMain()", 0)

IMPLEMENT_OP_CALL(Default_a_callMain, a, callMain(), int animRetVal = )
#endif // _OMINSTRUMENT
