...
#define OMAnim_Default_CO2Sensor_callMain_UNSERIALIZE_ARGS

#define OMAnim_Default_CO2Sensor_callMain_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define Default_CO2Sensor_changeFromHVAC_SERIALIZE OM_NO_OP

#define OMAnim_Default_CO2Sensor_changeFromHVAC_UNSERIALIZE_ARGS

#define OMAnim_Default_CO2Sensor_changeFromHVAC_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define Default_CO2Sensor_getCo2density_SERIALIZE OM_NO_OP

#define OMAnim_Default_CO2Sensor_getCo2density_UNSERIALIZE_ARGS

#define OMAnim_Default_CO2Sensor_getCo2density_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define Default_CO2Sensor_initilializeCo2sensor_SERIALIZE OM_NO_OP

#define OMAnim_Default_CO2Sensor_initilializeCo2sensor_UNSERIALIZE_ARGS

#define OMAnim_Default_CO2Sensor_initilializeCo2sensor_SERIALIZE_RET_VAL

#define Default_CO2Sensor_setModifying_bool_SERIALIZE aomsmethod->addAttribute("newValue", x2String(newValue));

#define OMAnim_Default_CO2Sensor_setModifying_bool_bool_UNSERIALIZE_ARGS OP_UNSER(OMDestructiveString2X,newValue)

#define OMAnim_Default_CO2Sensor_setModifying_bool_bool_SERIALIZE_RET_VAL
...
IMPLEMENT_META_OP(OMAnimatedCO2Sensor, Default_CO2Sensor_callMain, "callMain", FALSE, "callMain()", 0)

IMPLEMENT_OP_CALL(Default_CO2Sensor_callMain, CO2Sensor, callMain(), int animRetVal = )

IMPLEMENT_META_OP(OMAnimatedCO2Sensor, Default_CO2Sensor_changeFromHVAC, "changeFromHVAC", FALSE, "changeFromHVAC()", 0)

IMPLEMENT_OP_CALL(Default_CO2Sensor_changeFromHVAC, CO2Sensor, changeFromHVAC(), int animRetVal = )

IMPLEMENT_META_OP(OMAnimatedCO2Sensor, Default_CO2Sensor_getCo2density, "getCo2density", FALSE, "getCo2density()", 0)

IMPLEMENT_OP_CALL(Default_CO2Sensor_getCo2density, CO2Sensor, getCo2density(), float animRetVal = )

IMPLEMENT_META_OP(OMAnimatedCO2Sensor, Default_CO2Sensor_initilializeCo2sensor, "initilializeCo2sensor", FALSE, "initilializeCo2sensor()", 0)

IMPLEMENT_OP_CALL(Default_CO2Sensor_initilializeCo2sensor, CO2Sensor, initilializeCo2sensor(), NO_OP())

IMPLEMENT_META_OP(OMAnimatedCO2Sensor, Default_CO2Sensor_setModifying_bool_bool, "setModifying_bool", FALSE, "setModifying_bool(bool)", 1)

IMPLEMENT_OP_CALL(Default_CO2Sensor_setModifying_bool_bool, CO2Sensor, setModifying_bool(newValue), NO_OP())
