...
#define OMAnim_Default_HVAC_callMain_UNSERIALIZE_ARGS

#define OMAnim_Default_HVAC_callMain_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define Default_HVAC_getHvac_SERIALIZE OM_NO_OP

#define OMAnim_Default_HVAC_getHvac_UNSERIALIZE_ARGS

#define OMAnim_Default_HVAC_getHvac_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define Default_HVAC_getMode_SERIALIZE OM_NO_OP

#define OMAnim_Default_HVAC_getMode_UNSERIALIZE_ARGS

#define OMAnim_Default_HVAC_getMode_SERIALIZE_RET_VAL OP_SET_RET_VAL(animRetVal)

#define Default_HVAC_setHvac_SERIALIZE aomsmethod->addAttribute("newValue", x2String(newValue));

#define OMAnim_Default_HVAC_setHvac_float_UNSERIALIZE_ARGS OP_UNSER(OMDestructiveString2X,newValue)

#define OMAnim_Default_HVAC_setHvac_float_SERIALIZE_RET_VAL
...
IMPLEMENT_META_OP(OMAnimatedHVAC, Default_HVAC_callMain, "callMain", FALSE, "callMain()", 0)

IMPLEMENT_OP_CALL(Default_HVAC_callMain, HVAC, callMain(), int animRetVal = )

IMPLEMENT_META_OP(OMAnimatedHVAC, Default_HVAC_getHvac, "getHvac", FALSE, "getHvac()", 0)

IMPLEMENT_OP_CALL(Default_HVAC_getHvac, HVAC, getHvac(), float animRetVal = )

IMPLEMENT_META_OP(OMAnimatedHVAC, Default_HVAC_getMode, "getMode", FALSE, "getMode()", 0)

IMPLEMENT_OP_CALL(Default_HVAC_getMode, HVAC, getMode(), int animRetVal = )

IMPLEMENT_META_OP(OMAnimatedHVAC, Default_HVAC_setHvac_float, "setHvac", FALSE, "setHvac(float)", 1)

IMPLEMENT_OP_CALL(Default_HVAC_setHvac_float, HVAC, setHvac(newValue), NO_OP())
