...
//!	Generated Date	: Sat, 10, Jul 2021  
	File Path	: DefaultComponent\DefaultConfig\CO2Sensor.h
*********************************************************************/
...
//#[ ignore
#define OMAnim_Default_CO2Sensor_callMain_ARGS_DECLARATION

#define OMAnim_Default_CO2Sensor_changeFromHVAC_ARGS_DECLARATION

#define OMAnim_Default_CO2Sensor_getCo2density_ARGS_DECLARATION

#define OMAnim_Default_CO2Sensor_initilializeCo2sensor_ARGS_DECLARATION

#define OMAnim_Default_CO2Sensor_setModifying_bool_bool_ARGS_DECLARATION bool newValue;
...
#ifdef _OMINSTRUMENT
DECLARE_OPERATION_CLASS(Default_CO2Sensor_callMain)

DECLARE_OPERATION_CLASS(Default_CO2Sensor_changeFromHVAC)

DECLARE_OPERATION_CLASS(Default_CO2Sensor_getCo2density)

DECLARE_OPERATION_CLASS(Default_CO2Sensor_initilializeCo2sensor)

DECLARE_OPERATION_CLASS(Default_CO2Sensor_setModifying_bool_bool)
...
class OMAnimatedCO2Sensor : virtual public AOMInstance {
    ...
    DECLARE_META_OP(Default_CO2Sensor_callMain)
    
    DECLARE_META_OP(Default_CO2Sensor_changeFromHVAC)
    
    DECLARE_META_OP(Default_CO2Sensor_getCo2density)
    
    DECLARE_META_OP(Default_CO2Sensor_initilializeCo2sensor)
    
    DECLARE_META_OP(Default_CO2Sensor_setModifying_bool_bool)
