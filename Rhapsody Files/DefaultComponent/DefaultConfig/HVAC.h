...
//#[ ignore
#define OMAnim_Default_HVAC_callMain_ARGS_DECLARATION

#define OMAnim_Default_HVAC_getHvac_ARGS_DECLARATION

#define OMAnim_Default_HVAC_getMode_ARGS_DECLARATION

#define OMAnim_Default_HVAC_setHvac_float_ARGS_DECLARATION float newValue;
...
#ifdef _OMINSTRUMENT
DECLARE_OPERATION_CLASS(Default_HVAC_callMain)

DECLARE_OPERATION_CLASS(Default_HVAC_getHvac)

DECLARE_OPERATION_CLASS(Default_HVAC_getMode)

DECLARE_OPERATION_CLASS(Default_HVAC_setHvac_float)
...
class OMAnimatedHVAC : virtual public AOMInstance {
    ...
    DECLARE_META_OP(Default_HVAC_callMain)
    
    DECLARE_META_OP(Default_HVAC_getHvac)
    
    DECLARE_META_OP(Default_HVAC_getMode)
    
    DECLARE_META_OP(Default_HVAC_setHvac_float)
