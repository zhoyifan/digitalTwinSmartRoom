...
//!	Generated Date	: Sat, 10, Jul 2021  
	File Path	: DefaultComponent\DefaultConfig\AirConditioner.h
*********************************************************************/
...
//#[ ignore
#define OMAnim_Default_AirConditioner_SettingAirConditioner_ARGS_DECLARATION

#define OMAnim_Default_AirConditioner_callMain_ARGS_DECLARATION

#define OMAnim_Default_AirConditioner_callMain_copy_ARGS_DECLARATION

#define OMAnim_Default_AirConditioner_getSpeed_ARGS_DECLARATION

#define OMAnim_Default_AirConditioner_getTemperaturegoal_ARGS_DECLARATION

#define OMAnim_Default_AirConditioner_setDif_float_ARGS_DECLARATION float p_dif;

#define OMAnim_Default_AirConditioner_setHvac_float_ARGS_DECLARATION float p_hvac;

#define OMAnim_Default_AirConditioner_setTemperaturegoal_float_ARGS_DECLARATION float p_temperaturegoal;

#define OMAnim_Default_AirConditioner_setTemperatureroom_float_ARGS_DECLARATION float p_temperatureroom;
//#]
...
#ifdef _OMINSTRUMENT
DECLARE_OPERATION_CLASS(Default_AirConditioner_SettingAirConditioner)

DECLARE_OPERATION_CLASS(Default_AirConditioner_callMain)

DECLARE_OPERATION_CLASS(Default_AirConditioner_callMain_copy)

DECLARE_OPERATION_CLASS(Default_AirConditioner_getSpeed)

DECLARE_OPERATION_CLASS(Default_AirConditioner_getTemperaturegoal)

DECLARE_OPERATION_CLASS(Default_AirConditioner_setDif_float)

DECLARE_OPERATION_CLASS(Default_AirConditioner_setHvac_float)

DECLARE_OPERATION_CLASS(Default_AirConditioner_setTemperaturegoal_float)

DECLARE_OPERATION_CLASS(Default_AirConditioner_setTemperatureroom_float)

//#[ ignore
class OMAnimatedAirConditioner : virtual public AOMInstance {
    DECLARE_REACTIVE_META(AirConditioner, OMAnimatedAirConditioner)
    
    DECLARE_META_OP(Default_AirConditioner_SettingAirConditioner)
    
    DECLARE_META_OP(Default_AirConditioner_callMain)
    
    DECLARE_META_OP(Default_AirConditioner_callMain_copy)
    
    DECLARE_META_OP(Default_AirConditioner_getSpeed)
    
    DECLARE_META_OP(Default_AirConditioner_getTemperaturegoal)
    
    DECLARE_META_OP(Default_AirConditioner_setDif_float)
    
    DECLARE_META_OP(Default_AirConditioner_setHvac_float)
    
    DECLARE_META_OP(Default_AirConditioner_setTemperaturegoal_float)
    
    DECLARE_META_OP(Default_AirConditioner_setTemperatureroom_float)
